...
<body>
    <section>
        <div class="container">
            ...
            <a href="http://localhost:3000/PHP/Principal.php" class="nota">
            <div class="card" >
                <div class="content">
                    <div class="imgBX" ><img src="https://www.fondos12.com/data/big/12/ice_age_3__wallpaper_480x300.jpg" alt="Icono De Flecha En Estilo Plano - Icono Flecha Png@seekpng.com"></div>
                    <div class="contentBx">
                        <h3>Mi perfil</h3>
                    </div>
                </div>
            ...
            <a href="http://localhost:3000/PHP/login.php" class="nota">
            <div class="card" >
                <div class="content">
